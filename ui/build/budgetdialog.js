...
var BudgetDialog = function (_React$Component2) {
    ...
    function BudgetDialog(props) {
        ...
        return _possibleConstructorReturn(this, (BudgetDialog.__proto__ || Object.getPrototypeOf(BudgetDialog)).call(this, props));
    }
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'th',
                            null,
                            tr("Gross national product")
                        ),
                        React.createElement(
                            'td',
                            null,
                            valStr(this.props.gdp, '€')
                        )
                    ),
                    React.createElement(
                        'tr',
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            null,
                            ' + ',
                            valStr(this.props.gdp * this.props.taxRate, '€')
                        )
                    ),
                    React.createElement(
                        'tr',
                        ...
                        React.createElement(
                            ...
                            null,
                            ' - ',
                            valStr(this.props.gdp * this.props.regularTaxRate, '€')
                        )
                    )
                ),
                React.createElement(
